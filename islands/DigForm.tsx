...
import { NAMESERVERS, type NameserverId } from "../lib/nameservers.ts";
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
        <label class="flex flex-col gap-1">
          ...
          <input
            ...
            class="px-3 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            required
          />
        </label>
        <label class="flex flex-col gap-1">
        ...
        {nameserver.value === "custom" && (
          <label class="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder="1.1.1.1"
              class="px-3 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 font-mono text-sm"
            />
          </label>
        )}
      </div>
